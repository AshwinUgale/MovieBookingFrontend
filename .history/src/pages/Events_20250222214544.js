          ...
          events.map((event) => (
            <div key={event.id} className="bg-white border rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-3 text-left">
                ...
                {/* View Details Link (Fixed Positioning) */}
                <a
                  href={event.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block bg-blue-500 text-white py-1 mt-2 rounded text-sm hover:bg-blue-600 transition duration-200 text-center"
                >
                  View Details
                </a>
              </div>
